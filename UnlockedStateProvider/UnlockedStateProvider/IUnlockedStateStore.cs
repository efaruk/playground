...
namespace UnlockedStateProvider
{
    public interface IUnlockedStateStore //: IDisposable
    {
        ...
        /// <summary>
        ///     If you are accessing unlocked session another views' controller, before first view render done, you should save
        ///     your session for accessing it on another controller. (Partial view calling with ajax request).
        /// </summary>
        void SaveSession();
