...
namespace UnlockedStateProvider
{
    public static class UnlockedExtensions
    {
        ...
        public static string StartSessionIfNewWithCustomCookie(string cookieName, string sessionId = "",
            bool useMd5 = true)
        {
        ...
        public static string GetSessionId(this HttpContextBase context, string cookieName)
        {
            ...
            if (result == String.Empty)
            {
                if (context != null && context.Response != null && context.Response.Cookies != null &&
                    context.Response.Cookies.AllKeys.Any(s => s == cookieName))
                {
        ...
        public static string GetSessionItemKey(string keyName, string cookieName = DEFAULT_COOKIE_NAME,
            string sessionId = "")
        {
        ...
        public static void SetCookie(this HttpContextBase context, string cookieName, string value, bool httpOnly = true,
            string path = "/", bool isSecure = false, DateTime? expires = null)
        {
        ...
        public static void SetCookie(this ControllerContext context, string cookieName, string value,
            bool httpOnly = true, string path = "/", bool isSecure = false, DateTime? expires = null)
        {
